...
class AuthServices {
    ...
    async login(data) {
        ...
        if (jwtAccess && jwtRefresh) {
            ...
            (0, redis_service_1.redisSet)((0, redis_service_1.jwtIdKey)(user.id, "accessToken"), jwtidAccess, 30);
            (0, redis_service_1.redisSet)((0, redis_service_1.jwtIdKey)(user.id, "refreshToken"), jwtidRefresh, 7 * 60 * 24);
            return {
                accessToken,
                refreshToken,
            };
