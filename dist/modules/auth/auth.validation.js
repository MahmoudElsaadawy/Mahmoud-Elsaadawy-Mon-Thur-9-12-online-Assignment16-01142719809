...
exports.signupSchema = {
    body: zod_1.default.strictObject({
        ...
        gender: zod_1.default.union([
            zod_1.default.literal(user_types_1.GenderEnum.male),
            zod_1.default.literal(user_types_1.GenderEnum.female),
        ]),
        isOnline: zod_1.default.boolean().optional(),
        isActive: zod_1.default.boolean().optional(),
        provider: zod_1.default.number().optional(),
        role: zod_1.default.union([
            zod_1.default.literal(user_types_1.RoleEnum.user),
            zod_1.default.literal(user_types_1.RoleEnum.admin),
        ]),
